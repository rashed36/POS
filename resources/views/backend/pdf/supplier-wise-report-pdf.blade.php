...
<head>
    ...
    <title>Supplier Wise Report Pdf</title>
    <style>
      #customers {
...
<body>
    <div class="container">
      <div class="row">
        <p style="font-size: 20px;background: #328FF8;text-align: center;padding: 5px 10px 5px 10px;color: #fff">SUPPLIER WISE STOCK REPORT</p>
      </div>
      <div class="row">
      ...
      <hr style="margin-bottom: 0px;">
        <div class="row">
            <div class="col-md-12">
                <p><b>Supplier Name :</b>{{@$allData['0']['supplier']['name']}}</p>
