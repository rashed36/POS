...
<head>
    ...
    <title>Product Wise Report Pdf</title>
    <style>
      #customers {
...
<body>
    <div class="container">
      <div class="row">
        <p style="font-size: 20px;background: #328FF8;text-align: center;padding: 5px 10px 5px 10px;color: #fff">PRODUCT WISE STOCK REPORT</p>
      </div>
      <div class="row">
