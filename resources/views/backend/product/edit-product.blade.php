      ...
      <div class="container-fluid">
        ...
        <section class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                <form method="post" action="{{ route('products.update',$editData->id)}}" id="myFrom">
                    @csrf
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="name" id="name" value="{{$editData->name}}" placeholder="Enter Category Name" class="form-control">
